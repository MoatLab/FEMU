...
struct nvme_vendor_log {
        __u8                    nand_data_units_written[16];
        __u8                    super_capacitor_health;
        __u8                    corrected_media_error[16];
        __u8                    supported_features;
        __u8                    temp_throttling[7];
...
struct nvme_ms_log {
        __u16                   open_stream_cnt;
        __u16                   rsvd;
        __u16                   stream_id[2046];
};
...
enum {
	...
	NVME_LOG_GARBAGE_COLLECT	= 0x81,
	NVME_LOG_MULTI_STREAM		= 0x82,
	NVME_FWACT_REPL		= (0 << 3),
...
enum {
	...
	NVME_SC_MS_MAX_COUNT_REACHED	= 0x83,
	NVME_SC_MS_STREAM_NOT_OPEN	= 0x84,
	NVME_SC_MS_ILLEGAL_OPERATION	= 0x85,
	NVME_SC_MS_INVALID_ID		= 0x86,
...
static inline const char *nvme_status_to_string(__u32 status)
{
        switch (status & 0x3ff) {
        ...
        case NVME_SC_MS_MAX_COUNT_REACHED:      return "MAX_STREAM_COUNT_REACHED";
        case NVME_SC_MS_STREAM_NOT_OPEN:        return "STREAM_NOT_OPEN";
        case NVME_SC_MS_ILLEGAL_OPERATION:      return "ILLEGAL STREAM OPERATION";
        case NVME_SC_MS_INVALID_ID:     return "INVALID STREAM ID";
