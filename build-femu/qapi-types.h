...
typedef enum BlockdevDriver {
    ...
    BLOCKDEV_DRIVER_RBD = 25,
    BLOCKDEV_DRIVER_REPLICATION = 26,
    BLOCKDEV_DRIVER_SHEEPDOG = 27,
    BLOCKDEV_DRIVER_SSH = 28,
    BLOCKDEV_DRIVER_VDI = 29,
    BLOCKDEV_DRIVER_VHDX = 30,
    BLOCKDEV_DRIVER_VMDK = 31,
    BLOCKDEV_DRIVER_VPC = 32,
    BLOCKDEV_DRIVER_VVFAT = 33,
    BLOCKDEV_DRIVER__MAX = 34,
} BlockdevDriver;
...
typedef enum GuestPanicInformationType {
    ...
    GUEST_PANIC_INFORMATION_TYPE__MAX = 1,
} GuestPanicInformationType;

extern const char *const GuestPanicInformationType_lookup[];
...
typedef enum NetLegacyOptionsType {
    ...
    NET_LEGACY_OPTIONS_TYPE_DUMP = 7,
    NET_LEGACY_OPTIONS_TYPE_BRIDGE = 8,
    NET_LEGACY_OPTIONS_TYPE_NETMAP = 9,
    NET_LEGACY_OPTIONS_TYPE_VHOST_USER = 10,
    NET_LEGACY_OPTIONS_TYPE__MAX = 11,
} NetLegacyOptionsType;

extern const char *const NetLegacyOptionsType_lookup[];
...
typedef enum NumaOptionsType {
    ...
    NUMA_OPTIONS_TYPE__MAX = 1,
} NumaOptionsType;

extern const char *const NumaOptionsType_lookup[];
...
typedef struct SocketAddressFlatList SocketAddressFlatList;

typedef enum SocketAddressFlatType {
    SOCKET_ADDRESS_FLAT_TYPE_INET = 0,
    SOCKET_ADDRESS_FLAT_TYPE_UNIX = 1,
    SOCKET_ADDRESS_FLAT_TYPE_VSOCK = 2,
    SOCKET_ADDRESS_FLAT_TYPE_FD = 3,
    SOCKET_ADDRESS_FLAT_TYPE__MAX = 4,
} SocketAddressFlatType;

extern const char *const SocketAddressFlatType_lookup[];
...
typedef struct q_obj_SocketAddressFlat_base q_obj_SocketAddressFlat_base;
...
struct SocketAddressFlat {
    SocketAddressFlatType type;
    union { /* union tag is @type */
...
struct SocketAddressFlatList {
    SocketAddressFlatList *next;
    SocketAddressFlat *value;
};
...
struct q_obj_SocketAddressFlat_base {
    SocketAddressFlatType type;
};
