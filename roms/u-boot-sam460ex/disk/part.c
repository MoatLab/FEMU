...
#if defined(CONFIG_SAM440EP) || defined(CONFIG_SAM440EP_FLEX)
...
#endif
#if defined(CONFIG_SAM440EP) || defined(CONFIG_SAM440EP_FLEX)
	{ .name = "psii", .get_dev = p_sii_get_dev, },
	{ .name = "ssii", .get_dev = s_sii_get_dev, },	
	{ .name = "s4sii", .get_dev = s_4_sii_get_dev, },
#elif defined(CONFIG_SAM460EX)
	{ .name = "ssii", .get_dev = s_sii_get_dev, },	
	{ .name = "s4sii", .get_dev = s_4_sii_get_dev, },
	{ .name = "sata2-460", .get_dev = sata2_460_get_dev, },
#endif
	{ },
};
