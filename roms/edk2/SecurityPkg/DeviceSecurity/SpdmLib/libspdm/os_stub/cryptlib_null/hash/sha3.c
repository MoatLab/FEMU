...
/**
 * Initializes user-supplied memory pointed by sha3_256_ctx as SHA3-256 hash context for
 * subsequent use.
 *
 * If sha3_256_ctx is NULL, then return false.
 *
 * @param[out]  sha3_256_ctx  Pointer to SHA3-256 context being initialized.
 *
 * @retval true   SHA3-256 context initialization succeeded.
 * @retval false  SHA3-256 context initialization failed.
 *
 **/
bool libspdm_sha3_256_init(void *sha3_256_ctx)
{
    return false;
}
 ...
 *
 * If sha3_256_ctx is NULL, then return false.
 * If new_sha3_256_ctx is NULL, then return false.
 * If this interface is not supported, then return false.
 *
 * @param[in]  sha3_256_ctx     Pointer to SHA3-256 context being copied.
 * @param[out] new_sha3_256_ctx  Pointer to new SHA3-256 context.
 *
 ...
 *
 **/
bool libspdm_sha3_256_duplicate(const void *sha3_256_ctx,
                                void *new_sha3_256_ctx)
{
    return false;
}
 ...
 * If sha3_256_ctx is NULL, then return false.
 *
 * @param[in, out]  sha3_256_ctx  Pointer to the SHA3-256 context.
 ...
 *
 **/
bool libspdm_sha3_256_final(void *sha3_256_ctx, uint8_t *hash_value)
{
    return false;
}
